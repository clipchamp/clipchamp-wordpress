...
require_once(dirname(dirname(__DIR__)) . '/classes/ccb-settings.php');
 ...
 */
if ( ! class_exists('UnitTestCCB_Settings') ) {
	class UnitTestCCB_Settings extends UnitTestCase {
		public function __construct() {
			$this->WPPS_Settings = CCB_Settings::get_instance();
		}
		...
		public function test_magic_set() {
			...
			$this->assertEqual( $this->WPPS_Settings->settings['db-version'], Clipchamp_Button::VERSION );
			...
			$this->WPPS_Settings->settings = array( 'db-version' => Clipchamp_Button::VERSION );
			...
			$this->WPPS_Settings->settings['db-version'] = Clipchamp_Button::VERSION;
		}
