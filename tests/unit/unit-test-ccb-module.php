...
require_once(dirname(dirname(__DIR__)) . '/classes/ccb-module.php');
 ...
 */
if ( ! class_exists('UnitTestCCB_Module') ) {
	class UnitTestCCB_Module extends UnitTestCase {
		/*
		 * get_instance()
		 */
		public function test_get_instance() {
			// Two instances of the same module
			$first_instance = CCBChildClass::get_instance();
			$first_instance->init();
			$first_instance->foo = 'first';

			$second_instance = CCBChildClass::get_instance();
			...
			$separate_module = CCBAnotherChildClass::get_instance();
		...
		public function test_magic_get() {
			$child = CCBChildClass::get_instance();
...
if ( ! class_exists('CCBChildClass') ) {
	class CCBChildClass extends CCB_Module {
...
// Mock up a child class
if ( ! class_exists('CCBAnotherChildClass') ) {
	class CCBAnotherChildClass extends CCB_Module {
