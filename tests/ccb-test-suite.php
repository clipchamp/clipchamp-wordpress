 ...
 */
if ( ! class_exists('CCBTestSuite') ) {
	class CCBTestSuite extends TestSuite {
		function __construct() {
			parent::__construct();

			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-ccb-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-ccb-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-ccb-instance-class.php' );
		}
